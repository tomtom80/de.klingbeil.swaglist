...
public class UserTest {
	...
	public void testHandleCreateUser() {
		fixture.givenNoPriorActivity().when(new CreateUserCommand(userId, "Buyer 1", "buyer1", "buyer1"))
				.expectEvents(userCreatedEvent);
	}

	@Test
	public void testHandleAuthenticateUser() {
		fixture.given(userCreatedEvent).when(new AuthenticateUserCommand(userId, "buyer1", "buyer1".toCharArray()))
