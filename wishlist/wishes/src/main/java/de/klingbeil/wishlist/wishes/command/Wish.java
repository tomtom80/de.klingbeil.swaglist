...
public class Wish {
  ...
  public void handle(WishUpdateCommand command) {
    apply(new WishUpdatedEvent(wishId, command.getWishlistId(), command.getWishName(),
        command.getWishDescription(), command.getWishLocation(), command.getWishLocationUrl(),
        command.getWishImageUrl()));
  }
