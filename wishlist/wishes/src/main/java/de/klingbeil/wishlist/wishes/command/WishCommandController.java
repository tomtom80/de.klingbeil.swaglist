...
public class WishCommandController {
	...
	public Future<String> removeWishFromWishlist(@PathVariable String wishlistId, @PathVariable String wishId) {
		...
		return commandGateway.send(new RemoveWishFromWishlistCommand(new WishId(wishId), new WishlistId(wishlistId)));
	}
