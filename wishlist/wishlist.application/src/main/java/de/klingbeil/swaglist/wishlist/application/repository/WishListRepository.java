...
public class WishListRepository {
  ...
  public List<WishItem> findAll() {
    ...
    WishItem wishItem4 = new WishItem.Builder("4", "Plattform Taschenbuch ")
        ...
        .build();
    WishItem wishItem5 = new WishItem.Builder("5", "Philips Hue White & Color Ambiance")
        .description(
        ...
        .build();
    WishItem wishItem6 = new WishItem.Builder("6", "Cupcake Ipsum")
        .description(
        ...
        .build();
    WishItem wishItem7 = new WishItem.Builder("7", "Picksum Ipsum")
        .description(
        ...
        .build();
    WishItem wishItem8 = new WishItem.Builder("8", "Lorizzle")
        .description(
