...
public class Wishlist {
  ...
  public Wishlist(CreateWishlistCommand command) {
    apply(new WishlistCreatedEvent(command.getWishlistId(), command.getWishlistName(),
        command.getWishlistType()));
  }

  @CommandHandler
  public void handle(UpdateWishlistCommand command) {
    apply(
        new WishlistUpdatedEvent(wishlistId, command.getWishlistName(), command.getWishlistType()));
  }
